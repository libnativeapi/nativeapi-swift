...
public class MenuItem {
    ...
    /// - Returns: New menu item instance
    public static func create(_ text: String = "", type: MenuItemType = .normal) -> MenuItem? {
        guard let nativeItem = native_menu_item_create(text, type.nativeValue) else {
            return nil
        }
        return MenuItem(nativeItem: nativeItem)
    }
    
    /// Factory method to create a separator menu item.
    /// - Returns: New separator menu item instance
